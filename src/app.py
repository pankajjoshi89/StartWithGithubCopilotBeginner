...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team tactics and play competitive matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training, fitness, and swim meets",
    ...
    "Art Club": {
        ...
        "max_participants": 15,
        "participants": ["harper@mergington.edu", "zara@mergington.edu"]
    },
    "Drama Club": {
        "description": "Rehearse scenes, learn theater skills, and perform plays",
